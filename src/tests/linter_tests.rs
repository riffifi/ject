...
mod tests {
    ...
    fn test_unused_variable_warning() {
        ...
        assert!(warnings
            .iter()
            .any(|w| w.contains("unused") && w.contains("x")));
    }
...
"#,
        ...
        assert!(warnings
            .iter()
            .any(|w| w.contains("unused") && w.contains("y")));
        assert!(warnings
            .iter()
            .any(|w| w.contains("unused") && w.contains("z")));
    }
    ...
    fn test_undefined_variable_error() {
        ...
        assert!(errors
            .iter()
            .any(|e| e.contains("undefined") || e.contains("undeclared")));
    }
...
"#,
        ...
        assert!(warnings
            .iter()
            .any(|w| w.contains("already declared") || w.contains("shadow")));
    }
...
"#,
    ...
    fn test_assignment_to_undeclared() {
        ...
        assert!(errors
            .iter()
            .any(|e| e.contains("undeclared") || e.contains("assign")));
    }
...
"#,
    ...
    fn test_return_outside_function() {
        ...
        assert!(errors
            .iter()
            .any(|e| e.contains("return") && e.contains("outside")));
    }
...
"#,
        ...
        assert!(errors
            .iter()
            .any(|e| e.contains("my_variable") || e.contains("similar")));
    }
...
"#,
        ...
        assert!(errors
            .iter()
            .any(|e| e.contains("calculate_sum") || e.contains("similar")));
    }
