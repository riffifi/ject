...
pub fn is_native_only_module(name: &str) -> bool {
    name == "base" || name.starts_with("@native/")
}
...
pub fn create_corlib() -> HashMap<String, Value> {
    ...
    corlib.insert(
        "type_of".to_string(),
        Value::BuiltinFunction("type_of".to_string()),
    );
    corlib.insert(
        "to_int".to_string(),
    ...
    corlib.insert(
        "to_bool".to_string(),
        Value::BuiltinFunction("to_bool".to_string()),
    );
    ...
    corlib.insert(
        "range".to_string(),
        Value::BuiltinFunction("range".to_string()),
    );
    corlib.insert(
        "push".to_string(),
    ...
    corlib.insert(
        "slice".to_string(),
        Value::BuiltinFunction("slice".to_string()),
    );
    corlib.insert(
        "sort".to_string(),
    ...
    corlib.insert(
        "unique".to_string(),
        Value::BuiltinFunction("unique".to_string()),
    );
    ...
    corlib.insert(
        "random".to_string(),
        Value::BuiltinFunction("random".to_string()),
    );
    corlib.insert(
        "random_int".to_string(),
        Value::BuiltinFunction("random_int".to_string()),
    );
    ...
    corlib.insert(
        "upper".to_string(),
        Value::BuiltinFunction("upper".to_string()),
    );
    corlib.insert(
        "lower".to_string(),
        Value::BuiltinFunction("lower".to_string()),
    );
    corlib.insert(
        "trim".to_string(),
    ...
    corlib.insert(
        "repeat".to_string(),
        Value::BuiltinFunction("repeat".to_string()),
    );
    ...
    corlib.insert(
        ...
        Value::BuiltinFunction("append_file".to_string()),
    );
    corlib.insert(
        "read_lines".to_string(),
        Value::BuiltinFunction("read_lines".to_string()),
    );
    corlib.insert(
    ...
    corlib.insert(
        "assert".to_string(),
        Value::BuiltinFunction("assert".to_string()),
    );
    corlib.insert(
        "has_key".to_string(),
        Value::BuiltinFunction("has_key".to_string()),
    );
    corlib.insert(
        "delete".to_string(),
        Value::BuiltinFunction("delete".to_string()),
    );
    corlib.insert(
        "keys".to_string(),
        Value::BuiltinFunction("keys".to_string()),
    );
    corlib.insert(
        "values".to_string(),
        Value::BuiltinFunction("values".to_string()),
    );
...
pub fn get_math_module() -> HashMap<String, Value> {
    ...
    module.insert(
        "log10".to_string(),
        Value::BuiltinFunction("log10".to_string()),
    );
    module.insert("exp".to_string(), Value::BuiltinFunction("exp".to_string()));
    module.insert(
        "log2".to_string(),
        Value::BuiltinFunction("log2".to_string()),
    );
    ...
    module.insert(
        "degrees".to_string(),
        Value::BuiltinFunction("degrees".to_string()),
    );
    module.insert(
        "radians".to_string(),
        Value::BuiltinFunction("radians".to_string()),
    );
    module.insert(
        "deg_to_rad".to_string(),
        Value::BuiltinFunction("deg_to_rad".to_string()),
    );
    module.insert(
        "rad_to_deg".to_string(),
        Value::BuiltinFunction("rad_to_deg".to_string()),
    );

    // Advanced functions
    module.insert(
        "clamp".to_string(),
        Value::BuiltinFunction("clamp".to_string()),
    );
    module.insert(
        "sign".to_string(),
    ...
    module.insert(
        "atan2".to_string(),
        Value::BuiltinFunction("atan2".to_string()),
    );

    // Hyperbolic (not in CorLib)
    module.insert(
        "sinh".to_string(),
        Value::BuiltinFunction("sinh".to_string()),
    );
    module.insert(
        "cosh".to_string(),
        Value::BuiltinFunction("cosh".to_string()),
    );
    module.insert(
        "tanh".to_string(),
        Value::BuiltinFunction("tanh".to_string()),
    );

    // Rounding variants
    module.insert(
        "round_to".to_string(),
        Value::BuiltinFunction("round_to".to_string()),
    );
...
pub fn get_string_module() -> HashMap<String, Value> {
    ...
    module.insert(
        ...
        Value::BuiltinFunction("capitalize".to_string()),
    );
    module.insert(
        "title_case".to_string(),
        Value::BuiltinFunction("title_case".to_string()),
    );

    // Trimming variants
    module.insert(
        "trim_left".to_string(),
        Value::BuiltinFunction("trim_left".to_string()),
    );
    module.insert(
        "trim_right".to_string(),
        Value::BuiltinFunction("trim_right".to_string()),
    );

    // Padding
    module.insert(
        "pad_left".to_string(),
        Value::BuiltinFunction("pad_left".to_string()),
    );
    module.insert(
        "pad_right".to_string(),
        Value::BuiltinFunction("pad_right".to_string()),
    );
    module.insert(
        "pad_center".to_string(),
        Value::BuiltinFunction("pad_center".to_string()),
    );
    ...
    module.insert(
        ...
        Value::BuiltinFunction("contains_str".to_string()),
    );
    module.insert(
        "count".to_string(),
        Value::BuiltinFunction("count".to_string()),
    );
    module.insert(
        "find".to_string(),
    ...
    module.insert(
        ...
        Value::BuiltinFunction("replace_all".to_string()),
    );
    module.insert(
        "replace_first".to_string(),
        Value::BuiltinFunction("replace_first".to_string()),
    );
    module.insert(
        "remove".to_string(),
        Value::BuiltinFunction("remove".to_string()),
    );
    module.insert(
        "repeat".to_string(),
        Value::BuiltinFunction("repeat".to_string()),
    ...
    module.insert(
        ...
        Value::BuiltinFunction("reverse_str".to_string()),
    );

    // Extraction
    module.insert(
        "left".to_string(),
        Value::BuiltinFunction("left".to_string()),
    );
    module.insert(
        "right".to_string(),
        Value::BuiltinFunction("right".to_string()),
    );
    module.insert(
        "truncate".to_string(),
        Value::BuiltinFunction("truncate".to_string()),
    );

    // Analysis
    module.insert(
        "is_empty".to_string(),
        Value::BuiltinFunction("is_empty".to_string()),
    );
    module.insert(
        "is_numeric".to_string(),
        Value::BuiltinFunction("is_numeric".to_string()),
    );
    module.insert(
        "is_alpha".to_string(),
        Value::BuiltinFunction("is_alpha".to_string()),
    );
    module.insert(
        "is_alphanumeric".to_string(),
        Value::BuiltinFunction("is_alphanumeric".to_string()),
    );
    module.insert(
        "word_count".to_string(),
        Value::BuiltinFunction("word_count".to_string()),
    );
    module.insert(
        "sentence_count".to_string(),
        Value::BuiltinFunction("sentence_count".to_string()),
    );
    module.insert(
        "paragraph_count".to_string(),
        Value::BuiltinFunction("paragraph_count".to_string()),
    );
    module.insert(
        "lines".to_string(),
        Value::BuiltinFunction("lines".to_string()),
    );

    // Conversion utilities
    module.insert(
        "extract_numbers".to_string(),
        Value::BuiltinFunction("extract_numbers".to_string()),
    );
    module.insert(
        "to_char_codes".to_string(),
        Value::BuiltinFunction("to_char_codes".to_string()),
    );
    module.insert(
        "from_char_codes".to_string(),
        Value::BuiltinFunction("from_char_codes".to_string()),
    );

    // Formatting
    module.insert(
        "format".to_string(),
        Value::BuiltinFunction("format".to_string()),
    );
    module.insert(
        "escape".to_string(),
        Value::BuiltinFunction("escape".to_string()),
    );
    module.insert(
        "unescape".to_string(),
        Value::BuiltinFunction("unescape".to_string()),
    );
    module.insert(
        "wrap_text".to_string(),
        Value::BuiltinFunction("wrap_text".to_string()),
    );
...
pub fn get_array_module() -> HashMap<String, Value> {
    ...
    module.insert(
        "average".to_string(),
        Value::BuiltinFunction("average".to_string()),
    );
    module.insert(
        "median".to_string(),
        Value::BuiltinFunction("median".to_string()),
    );
    ...
    module.insert(
        "initial".to_string(),
        Value::BuiltinFunction("initial".to_string()),
    );
    module.insert(
        "rest".to_string(),
        Value::BuiltinFunction("rest".to_string()),
    );
    ...
    module.insert(
        "union".to_string(),
        Value::BuiltinFunction("union".to_string()),
    );
    module.insert(
        "intersection".to_string(),
        Value::BuiltinFunction("intersection".to_string()),
    );
    module.insert(
        "difference".to_string(),
        Value::BuiltinFunction("difference".to_string()),
    );
    ...
    module.insert(
        "chunk".to_string(),
        Value::BuiltinFunction("chunk".to_string()),
    );
    module.insert(
        "group_by".to_string(),
        Value::BuiltinFunction("group_by".to_string()),
    );
    module.insert(
        "partition".to_string(),
        Value::BuiltinFunction("partition".to_string()),
    );
    module.insert(
        "shuffle".to_string(),
        Value::BuiltinFunction("shuffle".to_string()),
    );
    module.insert(
        "rotate_left".to_string(),
        Value::BuiltinFunction("rotate_left".to_string()),
    );
    module.insert(
        "rotate_right".to_string(),
        Value::BuiltinFunction("rotate_right".to_string()),
    );

    // Modification
    module.insert(
        "insert_at".to_string(),
        Value::BuiltinFunction("insert_at".to_string()),
    );
    module.insert(
        "remove_at".to_string(),
        Value::BuiltinFunction("remove_at".to_string()),
    );
    module.insert(
        "without".to_string(),
        Value::BuiltinFunction("without".to_string()),
    );
    module.insert(
        "compact".to_string(),
        Value::BuiltinFunction("compact".to_string()),
    );
    module.insert(
        "compact_unique".to_string(),
        Value::BuiltinFunction("compact_unique".to_string()),
    );

    // Utilities
    module.insert(
        "enumerate".to_string(),
        Value::BuiltinFunction("enumerate".to_string()),
    );
    module.insert(
        "fill".to_string(),
        Value::BuiltinFunction("fill".to_string()),
    );
    module.insert(
        "range_arr".to_string(),
        Value::BuiltinFunction("range_arr".to_string()),
    );
    module.insert(
        "sample".to_string(),
        Value::BuiltinFunction("sample".to_string()),
    );
    module.insert(
        "sort_by".to_string(),
        Value::BuiltinFunction("sort_by".to_string()),
    );
    module.insert(
        "to_uarray".to_string(),
        Value::BuiltinFunction("to_uarray".to_string()),
    );
    module.insert(
        "to_array".to_string(),
        Value::BuiltinFunction("to_array".to_string()),
    );
...
pub fn get_json_module() -> HashMap<String, Value> {
    ...
    module.insert(
        ...
        Value::BuiltinFunction("parse_json".to_string()),
    );
    module.insert(
        "to_json".to_string(),
        Value::BuiltinFunction("to_json".to_string()),
    );
...
pub fn get_system_module() -> HashMap<String, Value> {
    ...
    module.insert(
        "exit".to_string(),
        Value::BuiltinFunction("exit".to_string()),
    );
    module.insert(
        "args".to_string(),
    ...
    module.insert(
        "timestamp".to_string(),
        Value::BuiltinFunction("timestamp".to_string()),
    );
    module.insert(
        "sleep".to_string(),
        Value::BuiltinFunction("sleep".to_string()),
    );
...
pub fn get_base_module() -> HashMap<String, Value> {
    ...
    module.insert(
        "to_binary".to_string(),
        Value::BuiltinFunction("to_binary".to_string()),
    );
    module.insert(
        "to_octal".to_string(),
        Value::BuiltinFunction("to_octal".to_string()),
    );
    module.insert(
        "to_hex".to_string(),
        Value::BuiltinFunction("to_hex".to_string()),
    );
    module.insert(
        "from_binary".to_string(),
        Value::BuiltinFunction("from_binary".to_string()),
    );
    module.insert(
        "from_octal".to_string(),
        Value::BuiltinFunction("from_octal".to_string()),
    );
    module.insert(
        "from_hex".to_string(),
        Value::BuiltinFunction("from_hex".to_string()),
    );
    module.insert(
        "base_repr".to_string(),
        Value::BuiltinFunction("base_repr".to_string()),
    );
    module.insert(
        "from_base".to_string(),
        Value::BuiltinFunction("from_base".to_string()),
    );
...
pub fn call_builtin_function(name: &str, args: Vec<Value>) -> Result<Value, RuntimeError> {
    ...
    match name {
            ...
            match (&args[0], &args[1]) {
                ...
                (Value::Integer(base), Value::Float(exp)) => {
                    ...
                    if *base < 0 && exp.fract() != 0.0 {
                        return Err(RuntimeError {
                            message: "pow(): negative base with non-integer exponent is undefined"
                                .to_string(),
                        });
                    }
        ...
        "write_file" => {
            if args.len() != 2 {
                return Err(RuntimeError {
                    message: "write_file() takes exactly 2 arguments, the file path and content"
                        .to_string(),
                });
            }
        ...
        "reduce" => {
            ...
            if args.len() != 3 {
                return Err(RuntimeError {
                    message: "reduce() takes exactly 3 arguments (array, function, initial)"
                        .to_string(),
                });
            }
            match &args[0] {
        ...
        "split" => {
            if args.len() != 2 {
                return Err(RuntimeError {
                    message: "split() takes exactly 2 arguments (string to split and delimiter)"
                        .to_string(),
                });
            }
        ...
        "join" => {
            if args.len() != 2 {
                return Err(RuntimeError {
                    message: "join() takes exactly 2 arguments (array to join and delimiter)"
                        .to_string(),
                });
            }
            ...
            match args.len() {
                2 => {
                    ...
                    match (&args[0], &args[1]) {
                        ...
                        _ => Err(RuntimeError {
                            message: "substring() requires a string and integer indices"
                                .to_string(),
                        }),
                    }
                }
                        ...
                        (Value::Integer(start), Value::Integer(end), Value::Integer(step)) => {
                            ...
                            if *step > 0 {
                                while current < *end {
                                    ...
                                    current =
                                        current.checked_add(*step).ok_or_else(|| RuntimeError {
        ...
        "index_of" => {
            ...
            match (&args[0], &args[1]) {
                (Value::Array(arr), value) => Ok(Value::Integer(
                    arr.borrow()
                        .iter()
                        .position(|x| x == value)
                        .map_or(-1, |i| i as i64),
            ...
            match (&args[0], &args[1], &args[2]) {
                (Value::Array(arr), Value::Integer(start), Value::Integer(end)) => {
                    ...
                    if start <= end {
                        ...
                        Err(RuntimeError {
                            message: "slice() start index must be less than or equal to end index"
                                .to_string(),
                        })
                    }
                }
        ...
        "from_base" => {
            ...
            match (&args[0], &args[1]) {
                (Value::String(s), Value::Integer(base)) => {
        ...
        "contains_str" => {
            if args.len() != 2 {
                return Err(RuntimeError {
                    message: "contains_str() takes exactly 2 arguments (string, substring)"
                        .to_string(),
                });
            }
            match (&args[0], &args[1]) {
        ...
        "pad_left" => {
            if args.len() != 3 {
                return Err(RuntimeError {
                    message: "pad_left() takes exactly 3 arguments (string, length, padding)"
                        .to_string(),
                });
            }
            match (&args[0], &args[1], &args[2]) {
                ...
                _ => Err(RuntimeError {
                    message: "pad_left() requires a string, integer length, and padding string"
                        .to_string(),
                }),
            }
        }
        "pad_right" => {
            if args.len() != 3 {
                return Err(RuntimeError {
                    message: "pad_right() takes exactly 3 arguments (string, length, padding)"
                        .to_string(),
                });
            }
            match (&args[0], &args[1], &args[2]) {
                ...
                _ => Err(RuntimeError {
                    message: "pad_right() requires a string, integer length, and padding string"
                        .to_string(),
                }),
            }
        }
        ...
        "remove_from" => {
            if args.len() != 2 {
                return Err(RuntimeError {
                    message: "remove_from() takes exactly 2 arguments (collection, item)"
                        .to_string(),
                });
            }
            match &args[0] {
        ...
        "has" => {
            ...
            match &args[0] {
                Value::Collection(set) => Ok(Value::Bool(set.contains(&args[1].to_string()))),
                _ => Err(RuntimeError {
        ...
        "union" => {
            if args.len() != 2 {
                return Err(RuntimeError {
                    message: "union() takes exactly 2 arguments (collection1, collection2)"
                        .to_string(),
                });
            }
            match (&args[0], &args[1]) {
                (Value::Collection(set1), Value::Collection(set2)) => {
                    let union_set: std::collections::HashSet<String> =
        ...
        "intersect" => {
            if args.len() != 2 {
                return Err(RuntimeError {
                    message: "intersect() takes exactly 2 arguments (collection1, collection2)"
                        .to_string(),
                });
            }
            match (&args[0], &args[1]) {
                (Value::Collection(set1), Value::Collection(set2)) => {
                    let intersection_set: std::collections::HashSet<String> =
        ...
        "difference" => {
            if args.len() != 2 {
                return Err(RuntimeError {
                    message: "difference() takes exactly 2 arguments (collection1, collection2)"
                        .to_string(),
                });
            }
            match (&args[0], &args[1]) {
                (Value::Collection(set1), Value::Collection(set2)) => {
                    let difference_set: std::collections::HashSet<String> =
        ...
        "is_subset" => {
            if args.len() != 2 {
                return Err(RuntimeError {
                    message: "is_subset() takes exactly 2 arguments (collection1, collection2)"
                        .to_string(),
                });
            }
            match (&args[0], &args[1]) {
        ...
        "is_superset" => {
            if args.len() != 2 {
                return Err(RuntimeError {
                    message: "is_superset() takes exactly 2 arguments (collection1, collection2)"
                        .to_string(),
                });
            }
            match (&args[0], &args[1]) {
        ...
        "clear_collection" => {
            ...
            match &args[0] {
                Value::Collection(_) => Ok(Value::Collection(std::collections::HashSet::new())),
                _ => Err(RuntimeError {
        ...
        "to_array" => {
            ...
            match &args[0] {
                Value::Collection(set) => {
                    if args.len() == 2 {
                        return Err(RuntimeError {
                            message: "to_array() delimiter parameter only works with strings"
                                .to_string(),
                        });
                    }
                ...
                _ => Err(RuntimeError {
                    message: "to_array() requires a collection, unique array, or string"
                        .to_string(),
                }),
            }
        }
...
fn ject_value_to_json(ject_value: &Value) -> Result<serde_json::Value, RuntimeError> {
    match ject_value {
        Value::StructInstance {
            ...
            json_obj.insert(
                "_type".to_string(),
                serde_json::Value::String(struct_name.clone()),
            );
        ...
        Value::StructDefinition { name, fields } => {
            ...
            json_obj.insert(
                "_type".to_string(),
                serde_json::Value::String("struct_definition".to_string()),
            );
            json_obj.insert("name".to_string(), serde_json::Value::String(name.clone()));
            let fields_array: Vec<serde_json::Value> = fields
                .iter()
        ...
        Value::Collection(set) => {
            let json_array: Vec<serde_json::Value> = set
                .iter()
        ...
        | Value::ModuleObject(_) => Err(RuntimeError {
